...
import Student_Assigned_material from "../student/Student_Assigned_material";
...
import Staff_Assign_material from "../Staff/Staff_Assign_material";
import Staff_Material_analysis from "../Staff/Staff_Material_analysis";
import Staff_Material_status from "../Staff/Staff_Material_status";
...
const Wrapper = (props) => {
  ...
  const urlToHeading = {
    ...
    "/student/Student_Assigned_material": "Assigned Material",
    ...
    "/Staff/Staff_Assign_material": "Assign Material",
    "/Staff/Staff_Material_analysis": "Material Analysis",
    "/Staff/Staff_Material_status": "Material Status",
    "/Profile": "Profile"
  };
      ...
      <div className={`d-flex ${isToggled ? "toggled" : ""} ${showLogoutModal ? "blur-background" : ""}`} id="wrapper">
        ...
        <div id="page-content-wrapper" className={isToggled ? "mobile-sidebar-open" : ""}>
          <Navbar
            ...
            handleLogout={handleLogout}
          />
          <div className={`container-fluid main-content px-3 ${isToggled ? "toggled" : ""}`}>
            <Routes>
              ...
              <Route path="student/Student_Assigned_material" element={<Student_Assigned_material />} />
              ...
              <Route path="Staff/Staff_Assign_material" element={<Staff_Assign_material />} />
              ...
              <Route path="Staff/Staff_Material_analysis" element={<Staff_Material_analysis />} />
              <Route path="Staff/Staff_Material_status" element={<Staff_Material_status />} />
            </Routes>
          </div>
        </div>
      </div>
